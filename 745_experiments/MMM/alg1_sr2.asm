...
MMM/alg1_sr2:     file format elf64-x86-64
...
0000000000001120 <main>:
    ...
    134a:	e8 11 09 00 00       	call   1c60 <Compare_MMM>
...
0000000000001970 <MMM_default>:
    ...
    19c7:	4c 8b 50 10          	mov    0x10(%rax),%r10
    19cb:	4c 8b 08             	mov    (%rax),%r9
    19ce:	4c 89 64 24 e0       	mov    %r12,-0x20(%rsp)
    19d3:	4c 8b 40 08          	mov    0x8(%rax),%r8
    19d7:	48 8b 78 18          	mov    0x18(%rax),%rdi
    19db:	48 89 6c 24 e8       	mov    %rbp,-0x18(%rsp)
    19e0:	f3 0f 10 4d 00       	movss  0x0(%rbp),%xmm1
    19e5:	f3 45 0f 10 36       	movss  (%r14),%xmm14
    19ea:	48 8d 59 fc          	lea    -0x4(%rcx),%rbx
    19ee:	31 c0                	xor    %eax,%eax
    19f0:	f3 45 0f 10 6d 04    	movss  0x4(%r13),%xmm13
    19f6:	f3 44 0f 10 5d 04    	movss  0x4(%rbp),%xmm11
    19fc:	4c 8d 59 04          	lea    0x4(%rcx),%r11
    1a00:	f3 45 0f 10 64 24 04 	movss  0x4(%r12),%xmm12
    1a07:	f3 45 0f 10 14 24    	movss  (%r12),%xmm10
    1a0d:	f3 0f 11 4c 24 cc    	movss  %xmm1,-0x34(%rsp)
    1a13:	f3 45 0f 10 4e 08    	movss  0x8(%r14),%xmm9
    1a19:	f3 45 0f 10 45 00    	movss  0x0(%r13),%xmm8
    1a1f:	f3 41 0f 10 7e 04    	movss  0x4(%r14),%xmm7
    1a25:	f3 41 0f 10 74 24 08 	movss  0x8(%r12),%xmm6
    1a2c:	f3 0f 10 6d 08       	movss  0x8(%rbp),%xmm5
    1a31:	f3 41 0f 10 65 08    	movss  0x8(%r13),%xmm4
    1a37:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
    1a3e:	00 00 
    1a40:	48 8b 14 46          	mov    (%rsi,%rax,2),%rdx
    1a44:	f3 41 0f 10 1c 02    	movss  (%r10,%rax,1),%xmm3
    1a4a:	f3 0f 10 14 1a       	movss  (%rdx,%rbx,1),%xmm2
    1a4f:	f3 0f 10 0c 0a       	movss  (%rdx,%rcx,1),%xmm1
    1a54:	f3 42 0f 10 04 1a    	movss  (%rdx,%r11,1),%xmm0
    1a5a:	44 0f 28 fa          	movaps %xmm2,%xmm15
    1a5e:	f3 44 0f 59 fb       	mulss  %xmm3,%xmm15
    1a63:	f3 44 0f 58 7c 24 cc 	addss  -0x34(%rsp),%xmm15
    1a6a:	f3 44 0f 11 7c 24 cc 	movss  %xmm15,-0x34(%rsp)
    1a71:	44 0f 28 f9          	movaps %xmm1,%xmm15
    1a75:	f3 44 0f 59 fb       	mulss  %xmm3,%xmm15
    1a7a:	f3 0f 59 d8          	mulss  %xmm0,%xmm3
    1a7e:	f3 45 0f 58 df       	addss  %xmm15,%xmm11
    1a83:	44 0f 28 fa          	movaps %xmm2,%xmm15
    1a87:	f3 0f 58 eb          	addss  %xmm3,%xmm5
    1a8b:	f3 41 0f 10 1c 01    	movss  (%r9,%rax,1),%xmm3
    1a91:	f3 44 0f 59 fb       	mulss  %xmm3,%xmm15
    1a96:	f3 45 0f 58 d7       	addss  %xmm15,%xmm10
    1a9b:	44 0f 28 f9          	movaps %xmm1,%xmm15
    1a9f:	f3 44 0f 59 fb       	mulss  %xmm3,%xmm15
    1aa4:	f3 0f 59 d8          	mulss  %xmm0,%xmm3
    1aa8:	f3 45 0f 58 e7       	addss  %xmm15,%xmm12
    1aad:	44 0f 28 fa          	movaps %xmm2,%xmm15
    1ab1:	f3 0f 58 f3          	addss  %xmm3,%xmm6
    1ab5:	f3 41 0f 10 1c 00    	movss  (%r8,%rax,1),%xmm3
    1abb:	f3 44 0f 59 fb       	mulss  %xmm3,%xmm15
    1ac0:	f3 45 0f 58 f7       	addss  %xmm15,%xmm14
    1ac5:	44 0f 28 f9          	movaps %xmm1,%xmm15
    1ac9:	f3 44 0f 59 fb       	mulss  %xmm3,%xmm15
    1ace:	f3 0f 59 d8          	mulss  %xmm0,%xmm3
    1ad2:	f3 41 0f 58 ff       	addss  %xmm15,%xmm7
    1ad7:	f3 44 0f 58 cb       	addss  %xmm3,%xmm9
    1adc:	f3 0f 10 1c 07       	movss  (%rdi,%rax,1),%xmm3
    1ae1:	48 83 c0 04          	add    $0x4,%rax
    1ae5:	f3 0f 59 d3          	mulss  %xmm3,%xmm2
    1ae9:	f3 0f 59 cb          	mulss  %xmm3,%xmm1
    1aed:	f3 0f 59 c3          	mulss  %xmm3,%xmm0
    1af1:	f3 44 0f 58 c2       	addss  %xmm2,%xmm8
    1af6:	f3 44 0f 58 e9       	addss  %xmm1,%xmm13
    1afb:	f3 0f 58 e0          	addss  %xmm0,%xmm4
    1aff:	48 3d 00 04 00 00    	cmp    $0x400,%rax
    1b05:	0f 85 35 ff ff ff    	jne    1a40 <MMM_default+0xd0>
    1b0b:	48 83 c1 0c          	add    $0xc,%rcx
    1b0f:	49 83 c6 0c          	add    $0xc,%r14
    1b13:	49 83 c5 0c          	add    $0xc,%r13
    1b17:	49 83 c4 0c          	add    $0xc,%r12
    1b1b:	f3 45 0f 11 76 f4    	movss  %xmm14,-0xc(%r14)
    1b21:	48 83 c5 0c          	add    $0xc,%rbp
    1b25:	f3 45 0f 11 6d f8    	movss  %xmm13,-0x8(%r13)
    1b2b:	f3 45 0f 11 64 24 f8 	movss  %xmm12,-0x8(%r12)
    1b32:	f3 44 0f 11 5d f8    	movss  %xmm11,-0x8(%rbp)
    1b38:	f3 45 0f 11 54 24 f4 	movss  %xmm10,-0xc(%r12)
    1b3f:	f3 45 0f 11 4e fc    	movss  %xmm9,-0x4(%r14)
    1b45:	f3 45 0f 11 45 f4    	movss  %xmm8,-0xc(%r13)
    1b4b:	f3 41 0f 11 7e f8    	movss  %xmm7,-0x8(%r14)
    1b51:	f3 41 0f 11 74 24 fc 	movss  %xmm6,-0x4(%r12)
    1b58:	f3 0f 10 74 24 cc    	movss  -0x34(%rsp),%xmm6
    1b5e:	f3 0f 11 6d fc       	movss  %xmm5,-0x4(%rbp)
    1b63:	f3 41 0f 11 65 fc    	movss  %xmm4,-0x4(%r13)
    1b69:	f3 0f 11 75 f4       	movss  %xmm6,-0xc(%rbp)
    1b6e:	48 81 f9 00 04 00 00 	cmp    $0x400,%rcx
    1b75:	0f 85 65 fe ff ff    	jne    19e0 <MMM_default+0x70>
    1b7b:	48 8b 44 24 d8       	mov    -0x28(%rsp),%rax
    1b80:	f3 0f 10 a0 fc 03 00 	movss  0x3fc(%rax),%xmm4
    1b87:	00 
    1b88:	48 8b 44 24 e8       	mov    -0x18(%rsp),%rax
    1b8d:	f3 0f 10 98 fc 03 00 	movss  0x3fc(%rax),%xmm3
    1b94:	00 
    1b95:	48 8b 44 24 d0       	mov    -0x30(%rsp),%rax
    1b9a:	f3 0f 10 90 fc 03 00 	movss  0x3fc(%rax),%xmm2
    1ba1:	00 
    1ba2:	48 8b 44 24 e0       	mov    -0x20(%rsp),%rax
    1ba7:	f3 0f 10 88 fc 03 00 	movss  0x3fc(%rax),%xmm1
    1bae:	00 
    1baf:	31 c0                	xor    %eax,%eax
    1bb1:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    1bb8:	48 8b 14 46          	mov    (%rsi,%rax,2),%rdx
    1bbc:	f3 41 0f 10 2c 02    	movss  (%r10,%rax,1),%xmm5
    1bc2:	f3 0f 10 82 fc 03 00 	movss  0x3fc(%rdx),%xmm0
    1bc9:	00 
    1bca:	f3 0f 59 e8          	mulss  %xmm0,%xmm5
    1bce:	f3 0f 58 dd          	addss  %xmm5,%xmm3
    1bd2:	f3 41 0f 10 2c 01    	movss  (%r9,%rax,1),%xmm5
    1bd8:	f3 0f 59 e8          	mulss  %xmm0,%xmm5
    1bdc:	f3 0f 58 cd          	addss  %xmm5,%xmm1
    1be0:	f3 41 0f 10 2c 00    	movss  (%r8,%rax,1),%xmm5
    1be6:	f3 0f 59 e8          	mulss  %xmm0,%xmm5
    1bea:	f3 0f 59 04 07       	mulss  (%rdi,%rax,1),%xmm0
    1bef:	48 83 c0 04          	add    $0x4,%rax
    1bf3:	f3 0f 58 d5          	addss  %xmm5,%xmm2
    1bf7:	f3 0f 58 e0          	addss  %xmm0,%xmm4
    1bfb:	48 3d 00 04 00 00    	cmp    $0x400,%rax
    1c01:	75 b5                	jne    1bb8 <MMM_default+0x248>
    1c03:	48 8b 44 24 d8       	mov    -0x28(%rsp),%rax
    1c08:	48 83 44 24 f0 20    	addq   $0x20,-0x10(%rsp)
    1c0e:	49 83 c7 20          	add    $0x20,%r15
    1c12:	f3 0f 11 a0 fc 03 00 	movss  %xmm4,0x3fc(%rax)
    1c19:	00 
    1c1a:	48 8b 44 24 e8       	mov    -0x18(%rsp),%rax
    1c1f:	f3 0f 11 98 fc 03 00 	movss  %xmm3,0x3fc(%rax)
    1c26:	00 
    1c27:	48 8b 44 24 d0       	mov    -0x30(%rsp),%rax
    1c2c:	f3 0f 11 90 fc 03 00 	movss  %xmm2,0x3fc(%rax)
    1c33:	00 
    1c34:	48 8b 44 24 e0       	mov    -0x20(%rsp),%rax
    1c39:	f3 0f 11 88 fc 03 00 	movss  %xmm1,0x3fc(%rax)
    1c40:	00 
    1c41:	4c 39 7c 24 f8       	cmp    %r15,-0x8(%rsp)
    1c46:	0f 85 58 fd ff ff    	jne    19a4 <MMM_default+0x34>
    1c4c:	5b                   	pop    %rbx
    1c4d:	5d                   	pop    %rbp
    1c4e:	41 5c                	pop    %r12
    1c50:	41 5d                	pop    %r13
...
0000000000001c60 <Compare_MMM>:
    1c60:	f3 0f 1e fa          	endbr64 
    1c64:	4c 8b 15 c5 23 00 00 	mov    0x23c5(%rip),%r10        # 4030 <test>
    1c6b:	4c 8b 1d b6 23 00 00 	mov    0x23b6(%rip),%r11        # 4028 <A>
    1c72:	45 31 c9             	xor    %r9d,%r9d
    1c75:	48 8b 3d a4 23 00 00 	mov    0x23a4(%rip),%rdi        # 4020 <B>
    1c7c:	4f 8b 04 0b          	mov    (%r11,%r9,1),%r8
    1c80:	4b 8b 34 0a          	mov    (%r10,%r9,1),%rsi
    1c84:	31 c9                	xor    %ecx,%ecx
    1c86:	f3 0f 10 0e          	movss  (%rsi),%xmm1
    1c8a:	31 c0                	xor    %eax,%eax
    1c8c:	0f 1f 40 00          	nopl   0x0(%rax)
    1c90:	48 8b 14 c7          	mov    (%rdi,%rax,8),%rdx
    1c94:	f3 0f 10 04 0a       	movss  (%rdx,%rcx,1),%xmm0
    1c99:	f3 41 0f 59 04 80    	mulss  (%r8,%rax,4),%xmm0
    1c9f:	48 83 c0 01          	add    $0x1,%rax
    1ca3:	f3 0f 58 c8          	addss  %xmm0,%xmm1
    1ca7:	f3 0f 11 0e          	movss  %xmm1,(%rsi)
    1cab:	48 3d 00 01 00 00    	cmp    $0x100,%rax
    1cb1:	75 dd                	jne    1c90 <Compare_MMM+0x30>
    1cb3:	48 83 c1 04          	add    $0x4,%rcx
    1cb7:	48 83 c6 04          	add    $0x4,%rsi
    1cbb:	48 81 f9 00 04 00 00 	cmp    $0x400,%rcx
    1cc2:	75 c2                	jne    1c86 <Compare_MMM+0x26>
    1cc4:	49 83 c1 08          	add    $0x8,%r9
    1cc8:	49 81 f9 00 08 00 00 	cmp    $0x800,%r9
    1ccf:	75 ab                	jne    1c7c <Compare_MMM+0x1c>
    1cd1:	48 8b 0d 60 23 00 00 	mov    0x2360(%rip),%rcx        # 4038 <C>
    1cd8:	f2 0f 10 1d b0 03 00 	movsd  0x3b0(%rip),%xmm3        # 2090 <_IO_stdin_used+0x90>
    1cdf:	00 
    1ce0:	31 c0                	xor    %eax,%eax
    1ce2:	f3 0f 10 15 96 03 00 	movss  0x396(%rip),%xmm2        # 2080 <_IO_stdin_used+0x80>
    1ce9:	00 
    1cea:	49 8b 3c 02          	mov    (%r10,%rax,1),%rdi
    1cee:	48 8b 34 01          	mov    (%rcx,%rax,1),%rsi
    1cf2:	31 d2                	xor    %edx,%edx
    1cf4:	f3 0f 10 0c 16       	movss  (%rsi,%rdx,1),%xmm1
    1cf9:	0f 28 c1             	movaps %xmm1,%xmm0
    1cfc:	f3 0f 5c 04 17       	subss  (%rdi,%rdx,1),%xmm0
    1d01:	0f 54 ca             	andps  %xmm2,%xmm1
    1d04:	f3 0f 5a c9          	cvtss2sd %xmm1,%xmm1
    1d08:	0f 54 c2             	andps  %xmm2,%xmm0
    1d0b:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1d0f:	f2 0f 5e c1          	divsd  %xmm1,%xmm0
    1d13:	66 0f 2f d8          	comisd %xmm0,%xmm3
    1d17:	76 1f                	jbe    1d38 <Compare_MMM+0xd8>
    1d19:	48 83 c2 04          	add    $0x4,%rdx
    1d1d:	48 81 fa 00 04 00 00 	cmp    $0x400,%rdx
    1d24:	75 ce                	jne    1cf4 <Compare_MMM+0x94>
    1d26:	48 83 c0 08          	add    $0x8,%rax
    1d2a:	48 3d 00 08 00 00    	cmp    $0x800,%rax
    1d30:	75 b8                	jne    1cea <Compare_MMM+0x8a>
    1d32:	31 c0                	xor    %eax,%eax
    1d34:	c3                   	ret    
    1d35:	0f 1f 00             	nopl   (%rax)
    1d38:	b8 01 00 00 00       	mov    $0x1,%eax
    1d3d:	c3                   	ret    
    1d3e:	66 90                	xchg   %ax,%ax

0000000000001d40 <equal>:
    1d40:	f3 0f 1e fa          	endbr64 
    1d44:	0f 28 d0             	movaps %xmm0,%xmm2
    1d47:	f3 0f 10 1d 31 03 00 	movss  0x331(%rip),%xmm3        # 2080 <_IO_stdin_used+0x80>
    1d4e:	00 
    1d4f:	31 c0                	xor    %eax,%eax
    1d51:	f3 0f 5c d1          	subss  %xmm1,%xmm2
    1d55:	0f 54 c3             	andps  %xmm3,%xmm0
    1d58:	66 0f ef c9          	pxor   %xmm1,%xmm1
    1d5c:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1d60:	0f 54 d3             	andps  %xmm3,%xmm2
    1d63:	f3 0f 5a ca          	cvtss2sd %xmm2,%xmm1
    1d67:	f2 0f 5e c8          	divsd  %xmm0,%xmm1
    1d6b:	f2 0f 10 05 1d 03 00 	movsd  0x31d(%rip),%xmm0        # 2090 <_IO_stdin_used+0x90>
    1d72:	00 
    1d73:	66 0f 2f c1          	comisd %xmm1,%xmm0
    1d77:	0f 96 c0             	setbe  %al
    1d7a:	c3                   	ret    

Disassembly of section .fini:

0000000000001d7c <_fini>:
    1d7c:	f3 0f 1e fa          	endbr64 
    1d80:	48 83 ec 08          	sub    $0x8,%rsp
    1d84:	48 83 c4 08          	add    $0x8,%rsp
    1d88:	c3                   	ret    
