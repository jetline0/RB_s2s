...
if (N >= 1) {
  ...
  float Z7, Z14, Z12, Z13, Z10, Z11, Y1, Z8;
  float Z9, Z4, Z5, Z6, X1, Z1, Z2, Z3;
  if (N>=1) {
    for (t1=0; t1<=N-1-13; t1=t1+14) {
      ...
      for (t2=0; t2<=N-1; t2++ ) {
        X1=X[t2];
        {
          ...
          Z9=Z9+Y[(t1+6)][t2]+X1;
          ;
          Z10=Z10+Y[(t1+7)][t2]+X1;
          ;
          Z4=Z4+Y[(t1+8)][t2]+X1;
          ;
          Z6=Z6+Y[(t1+9)][t2]+X1;
          ;
          Z12=Z12+Y[(t1+10)][t2]+X1;
          ;
          Z3=Z3+Y[(t1+11)][t2]+X1;
          ;
          Z14=Z14+Y[(t1+12)][t2]+X1;
          ;
          Z13=Z13+Y[(t1+13)][t2]+X1;
          ;
        }
      }
      Z[(t1+4)]=Z1;
