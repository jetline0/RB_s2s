      ...
      for (t2=0; t2<=X-1; t2++ ) {
        for (t3=0; t3<=M-1-2; t3=t3+3) {
          ...
          for (t4=0; t4<=D-1; t4++ ) {
            ...
            scv_2=in[(t1+3)][t2][t4];
            scv_3=filter[t3][t4];
            scv_4=filter[(t3+2)][t4];
            scv_5=filter[(t3+1)][t4];
            scv_6=in[t1][t2][t4];
            scv_7=in[(t1+1)][t2][t4];
            scv_15=scv_15+scv_6*scv_3;
            ;
            scv_11=scv_11+scv_7*scv_3;
            ;
            scv_16=scv_16+scv_1*scv_3;
            ;
            scv_10=scv_10+scv_2*scv_3;
            ;
            scv_19=scv_19+scv_6*scv_5;
            ;
            scv_9=scv_9+scv_7*scv_5;
            ;
            scv_17=scv_17+scv_1*scv_5;
            ;
            scv_13=scv_13+scv_2*scv_5;
            ;
            scv_8=scv_8+scv_6*scv_4;
            ;
            scv_14=scv_14+scv_7*scv_4;
            ;
            scv_12=scv_12+scv_1*scv_4;
            ;
            scv_18=scv_18+scv_2*scv_4;
            ;
          }
        ...
        for (; t3<=M-1; t3++ ) {
          ...
          for (t4=0; t4<=D-1; t4++ ) {
            float scv_20;
            scv_20=filter[t3][t4];
            scv_24=scv_24+in[t1][t2][t4]*scv_20;
            ;
            scv_23=scv_23+in[(t1+1)][t2][t4]*scv_20;
            ;
            scv_22=scv_22+in[(t1+2)][t2][t4]*scv_20;
            ;
            scv_21=scv_21+in[(t1+3)][t2][t4]*scv_20;
            ;
          }
    ...
    for (; t1<=Y-1; t1++ ) {
      for (t2=0; t2<=X-1; t2++ ) {
        for (t3=0; t3<=M-1; t3++ ) {
          ...
          scv_25=out[t1][t2][t3];
          for (t4=0; t4<=D-1; t4++ ) {
            scv_25=scv_25+in[t1][t2][t4]*filter[t3][t4];
            ;
          }
          out[t1][t2][t3]=scv_25;
        }
