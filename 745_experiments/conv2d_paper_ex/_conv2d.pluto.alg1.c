...
if ((D >= 1) && (M >= 1) && (X >= 1) && (Y >= 1)) {
  ...
  float out1, out2, out3, out4, in1, filter1, filter2;
  if ((D>=1)&&(M>=1)&&(X>=1)&&(Y>=1)) {
    for (t1=0; t1<=Y-1-1; t1=t1+2) {
      for (t2=0; t2<=X-1; t2++ ) {
        for (t3=0; t3<=M-1-1; t3=t3+2) {
          ...
          out3=out[t1][t2][t3];
          for (t4=0; t4<=D-1; t4++ ) {
            filter1=filter[(t3+1)][t4];
            filter2=filter[t3][t4];
            {
              in1=in[t1][t2][t4];
              out3=out3+in1*filter2;
              out4=out4+in1*filter1;
            }
            {
              in1=in[(t1+1)][t2][t4];
              out2=out2+in1*filter2;
              out1=out1+in1*filter1;
            }
          }
          out[(t1+1)][t2][t3]=out2;
