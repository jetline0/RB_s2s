...
if (N >= 1) {
  for (t1=0;t1<=N-1-4;t1+=5) {
    for (t2=0;t2<=N-1-3;t2+=4) {
      for (t3=0;t3<=N-1;t3++) {
        for (t4=0;t4<=N-1;t4++) {
          ...
          out[(t1+4)][t2][t3] += A[(t1+4)][t2][t4] * C[t4][t3];;
          out[t1][(t2+1)][t3] += A[t1][(t2+1)][t4] * C[t4][t3];;
          out[(t1+1)][(t2+1)][t3] += A[(t1+1)][(t2+1)][t4] * C[t4][t3];;
          out[(t1+2)][(t2+1)][t3] += A[(t1+2)][(t2+1)][t4] * C[t4][t3];;
          out[(t1+3)][(t2+1)][t3] += A[(t1+3)][(t2+1)][t4] * C[t4][t3];;
          out[(t1+4)][(t2+1)][t3] += A[(t1+4)][(t2+1)][t4] * C[t4][t3];;
          out[t1][(t2+2)][t3] += A[t1][(t2+2)][t4] * C[t4][t3];;
          out[(t1+1)][(t2+2)][t3] += A[(t1+1)][(t2+2)][t4] * C[t4][t3];;
          out[(t1+2)][(t2+2)][t3] += A[(t1+2)][(t2+2)][t4] * C[t4][t3];;
          out[(t1+3)][(t2+2)][t3] += A[(t1+3)][(t2+2)][t4] * C[t4][t3];;
          out[(t1+4)][(t2+2)][t3] += A[(t1+4)][(t2+2)][t4] * C[t4][t3];;
          out[t1][(t2+3)][t3] += A[t1][(t2+3)][t4] * C[t4][t3];;
          out[(t1+1)][(t2+3)][t3] += A[(t1+1)][(t2+3)][t4] * C[t4][t3];;
          out[(t1+2)][(t2+3)][t3] += A[(t1+2)][(t2+3)][t4] * C[t4][t3];;
          out[(t1+3)][(t2+3)][t3] += A[(t1+3)][(t2+3)][t4] * C[t4][t3];;
          out[(t1+4)][(t2+3)][t3] += A[(t1+4)][(t2+3)][t4] * C[t4][t3];;
        }
      }
    }
    for (;t2<=N-1;t2++) {
