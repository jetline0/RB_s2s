...
if (N >= 1) {
  ...
  if (N>=1) {
    for (t1=0; t1<=N-1-5; t1=t1+6) {
      for (t2=0; t2<=N-1; t2++ ) {
        float scv_1, scv_2, scv_3, scv_4, scv_5, scv_6, scv_7, scv_8;
        scv_1=A[(t1+3)][t2];
        scv_2=A[(t1+1)][t2];
        scv_3=A[(t1+5)][t2];
        scv_4=A[t1][t2];
        ...
        scv_7=v2[t2];
        scv_8=A[(t1+4)][t2];
        scv_4=scv_4+u1[t1]*scv_5+u2[t1]*scv_7;
        ;
        scv_2=scv_2+u1[(t1+1)]*scv_5+u2[(t1+1)]*scv_7;
        ;
        scv_6=scv_6+u1[(t1+2)]*scv_5+u2[(t1+2)]*scv_7;
        ;
        scv_1=scv_1+u1[(t1+3)]*scv_5+u2[(t1+3)]*scv_7;
        ;
        scv_8=scv_8+u1[(t1+4)]*scv_5+u2[(t1+4)]*scv_7;
        ;
        scv_3=scv_3+u1[(t1+5)]*scv_5+u2[(t1+5)]*scv_7;
        ;
        A[(t1+3)][t2]=scv_1;
        A[(t1+1)][t2]=scv_2;
        A[(t1+5)][t2]=scv_3;
    ...
    for (; t1<=N-1; t1++ ) {
      for (t2=0; t2<=N-1; t2++ ) {
        float scv_9;
        scv_9=A[t1][t2];
        scv_9=scv_9+u1[t1]*v1[t2]+u2[t1]*v2[t2];
        ;
        A[t1][t2]=scv_9;
      }
    }
