...
if ((D >= 1) && (M >= 1) && (X >= 1) && (Y >= 1)) {
  for (t1=0;t1<=Y-1-4;t1+=5) {
    for (t2=0;t2<=X-1;t2++) {
      for (t3=0;t3<=D-1-4;t3+=5) {
        for (t4=0;t4<=M-1;t4++) {
          ...
          in[(t1+4)][t2][t3] += out[(t1+4)][t2][t4] * filter[t4][t3];;
          ...
          in[(t1+4)][t2][(t3+1)] += out[(t1+4)][t2][t4] * filter[t4][(t3+1)];;
          ...
          in[(t1+4)][t2][(t3+2)] += out[(t1+4)][t2][t4] * filter[t4][(t3+2)];;
          in[t1][t2][(t3+3)] += out[t1][t2][t4] * filter[t4][(t3+3)];;
          in[(t1+1)][t2][(t3+3)] += out[(t1+1)][t2][t4] * filter[t4][(t3+3)];;
          in[(t1+2)][t2][(t3+3)] += out[(t1+2)][t2][t4] * filter[t4][(t3+3)];;
          in[(t1+3)][t2][(t3+3)] += out[(t1+3)][t2][t4] * filter[t4][(t3+3)];;
          in[(t1+4)][t2][(t3+3)] += out[(t1+4)][t2][t4] * filter[t4][(t3+3)];;
          in[t1][t2][(t3+4)] += out[t1][t2][t4] * filter[t4][(t3+4)];;
          in[(t1+1)][t2][(t3+4)] += out[(t1+1)][t2][t4] * filter[t4][(t3+4)];;
          in[(t1+2)][t2][(t3+4)] += out[(t1+2)][t2][t4] * filter[t4][(t3+4)];;
          in[(t1+3)][t2][(t3+4)] += out[(t1+3)][t2][t4] * filter[t4][(t3+4)];;
          in[(t1+4)][t2][(t3+4)] += out[(t1+4)][t2][t4] * filter[t4][(t3+4)];;
        }
      }
      for (;t3<=D-1;t3++) {
        for (t4=0;t4<=M-1;t4++) {
